# Tharsolketha Press — Stories from renvashen.com

<div align="center">
  <!-- Update preview image and branding as needed -->
  <p align="center">
    <strong>Stories from the world of Tharsolketha, published by Joseph Roberts at <a href="https://renvashen.com">renvashen.com</a></strong>
  </p>
...
- **Monochrome Elegance**: Clean, minimal design focused on immersive storytelling
- **Author-Centric**: All stories and posts are by Joseph Roberts
- **Worldbuilding**: Content centers on the Tharsolketha story world and label
...
- **Markdown Support**: Write stories and posts in Markdown with frontmatter
- **Rich Metadata**: Support for categories, tags, publication dates, and featured stories


### 🗂️ **Organization Features**

- **Categories System**: Organize stories by categories with dedicated pages
- **Tags System**: Flexible tagging with tag-specific pages
- **Featured Stories**: Highlight your best work on the homepage
...
### � **Author & Publishing Label**

- **Single Author**: All stories and posts are by Joseph Roberts
- **Publishing Label**: Tharsolketha Press
...
git clone https://github.com/jjtroberts/renvashen-site.git
cd renvashen-site
...
export default {
  ...
  showFeaturedPostsOnHomePage: true, // Display featured posts section
...
| `showFeaturedPostsOnHomePage`        | Boolean | `true`                | Show featured posts section on homepage      |
